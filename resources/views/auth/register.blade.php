  ...
  <body>
    <div class="container-scroller">
        <div class="container-fluid page-body-wrapper full-page-wrapper">
            <div class="content-wrapper d-flex align-items-center bg-dark auth theme-one">
                <div class="row w-100">
                    <div class="col-lg-4 mx-auto">
                        <h2 class="text-center mb-4" style="color:white;">Personal Registration is Unavailable</h2>
                        <div class="auto-form-wrapper">
                            <p><b>PLEASE ASK ADMIN TO REGISTER YOUR ACCOUNT</b></p>
